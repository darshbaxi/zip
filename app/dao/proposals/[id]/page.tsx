...
export default function ProposalDetailPage() {
  ...
  const proposal = {
    ...
    fullDescription: `
## Overview
This proposal aims to create a fair and sustainable revenue sharing model for AI agents on the FlowHire platform. By implementing a 15% royalty system, we ensure that AI agent creators are properly compensated for their contributions while maintaining platform sustainability.
