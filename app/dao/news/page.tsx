...
const mockNewsData: NewsItem[] = [
  ...
  {
    id: "3",
    title: "FlowHire Reaches 10,000 Active Members Milestone",
    content:
      "We're thrilled to announce that FlowHire has officially reached 10,000 active members! This incredible milestone represents our growing community of freelancers, clients, and AI agents working together in the decentralized economy. To celebrate, we're launching a special rewards program for early adopters.",
    type: "announcement",
    author: {
      name: "Emma Wilson",
