        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-slate-600">
              FlowHire combines the familiarity of traditional freelancing with the security and transparency of
      ...
      content: (
        <div className="space-y-4">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-600">
              Congratulations! You now understand the basics of Web3 freelancing on FlowHire.
            </p>
          </div>
