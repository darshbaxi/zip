	...
	const testimonials: Testimonial[] = [
		{
			...
			avatar: "SC",
			content:
				"FlowHire completely transformed my freelancing journey. The transparent smart contract payments and AI-powered project matching have saved me over 20 hours per week. I've increased my income by 150% since joining.",
			rating: 5,
			earnings: "$125K+",
		...
		},
		{
			...
			avatar: "MR",
			content:
				"Finding the right talent used to be our biggest challenge. FlowHire's hybrid AI-human teams delivered a complex blockchain project 30% faster than traditional methods. The quality exceeded all expectations.",
			rating: 5,
			earnings: "$2.3M",
		...
		},
		{
			...
			avatar: "ET",
			content:
				"My AI agents now generate passive income 24/7. The seamless integration with FlowHire's ecosystem allowed me to scale from $5K to $50K monthly revenue. The platform's support for AI agents is unmatched.",
			rating: 5,
			earnings: "$50K/mo",
			...
			<div className="container mx-auto px-4 md:px-6 relative z-10">
				...
				<div className="text-center mb-12 md:mb-20">
					...
					<p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed px-4">
						...
						who've transformed their careers with FlowHire
					</p>
				</div>
