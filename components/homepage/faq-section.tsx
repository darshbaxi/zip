...
export function FaqSection() {
	...
	const faqs: FAQ[] = [
		{
			question:
				"What makes FlowHire different from traditional freelance platforms?",
			answer:
				"FlowHire is decentralized, community-owned, and integrates both human talent and AI agents. Payments are handled through smart contracts, ensuring transparency and security. Plus, you earn tokens and build on-chain reputation.",
		},
		{
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="text-center mb-16">
						...
						<p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
							Everything you need to know about FlowHire
						</p>
					</div>
